...
public class Standup extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Literary%2FStandup%2Fstandup1.jpg?alt=media&token=1d1f407d-7f29-41f6-89e1-5e0a09f54125","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Literary%2FStandup%2Fstandup2.jpg?alt=media&token=be1f7a96-1796-4a8f-b56d-e62a92efa6da","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Literary%2FStandup%2Fstandup3.jpg?alt=media&token=04f46087-23c7-4eb3-a5a8-f278977fb9e1"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus46()){
            //todo:set context
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPreferenceConfig.getstatus46()){
                    ...
                    sharedPreferenceConfig.writeImagestatus46(true);
                }else{
                    ...
                    sharedPreferenceConfig.writeImagestatus46(false);
                    imageView.setImageResource(R.drawable.belloff);
                }
                }else{
