...
public class CSGO extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Games%2FCSGO%2Fcsgo1.jpg?alt=media&token=5fd0a5e0-3727-4bac-84d1-8b06acb3d37c","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Games%2FCSGO%2Fcsgo2.jpg?alt=media&token=ec0308c1-1769-4ed7-8903-a434611dae10","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Games%2FCSGO%2Fcsgo3.jpg?alt=media&token=6ac658b1-a317-4225-b78a-4a9335f7a22a"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus8()){
            //todo:set context
            ...
            public void onClick(View v) {
                ...
                if(connected){
                    if(!sharedPreferenceConfig.getstatus8()){
                        ...
                        sharedPreferenceConfig.writeImagestatus8(true);
                    }else{
                        ...
                        sharedPreferenceConfig.writeImagestatus8(false);
                        imageView.setImageResource(R.drawable.belloff);
                    }
                }
                else{
