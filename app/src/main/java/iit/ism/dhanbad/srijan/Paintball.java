...
public class Paintball extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Games%2FPaintball%2Fpb1(1).jpg?alt=media&token=c2c33a78-c4e4-41fe-ae7a-18ebe9faf152","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Games%2FPaintball%2Fpb2.jpg?alt=media&token=be0d6906-e3d5-42f8-875e-7c5617dc84e7","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Games%2FPaintball%2Fpb3.jpg?alt=media&token=213711a8-77e8-4f4e-9b3c-facbd25e859f"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus30()){
            //todo:set context
            ...
            public void onClick(View v) {
                ...
                if(connected){
                    if(!sharedPreferenceConfig.getstatus30()){
                        ...
                        sharedPreferenceConfig.writeImagestatus30(true);
                    }else{
                        ...
                        sharedPreferenceConfig.writeImagestatus30(false);
                        imageView.setImageResource(R.drawable.belloff);
                    }
                }
                else{
