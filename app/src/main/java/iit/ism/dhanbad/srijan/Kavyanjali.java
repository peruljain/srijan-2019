...
public class Kavyanjali extends MainActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        slide2HeadingTextView.setText("Hindi Literary");
        ...
        cardsList.add(new cards(R.color.card3, "Kavi Sammelan", R.drawable.paironstage));
