...
public class DoodleMaking extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/FineArt%2FDoodleMaking%2Fclip1.jpg?alt=media&token=49fd5066-1d79-4d6d-818f-fdadb3a1f2e3","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/FineArt%2FDoodleMaking%2Fclip2.jpg?alt=media&token=6c97218b-f9d2-46ab-a5a3-3738204d17d0","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/FineArt%2FDoodleMaking%2Fclip3.jpg?alt=media&token=e5567a16-8491-4255-9265-2588dc73094c"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus10()){
            //todo:set context
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPreferenceConfig.getstatus10()){
                    ...
                    sharedPreferenceConfig.writeImagestatus10(true);
                }else{

                    FirebaseMessaging.getInstance().subscribeToTopic("DoodleMaking");//Todo:event name
                    //todo:set context
                    Toast.makeText(DoodleMaking.this,"Successfully subscribed for notifications",Toast.LENGTH_LONG).show();
                    sharedPreferenceConfig.writeImagestatus10(false);
                    imageView.setImageResource(R.drawable.belloff);
                }
