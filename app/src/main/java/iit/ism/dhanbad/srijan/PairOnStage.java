...
public class PairOnStage extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Musical%2FPair%20on%20Stage%2Fduet%20song1.jpg?alt=media&token=8b3d2413-b411-4ac4-97a9-8d6db4d94c53","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Musical%2FPair%20on%20Stage%2Fduet%20song2.jpg?alt=media&token=12c0941c-c4ad-4721-80c8-80b9fb634b72","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Musical%2FPair%20on%20Stage%2Fduet%20song3.jpg?alt=media&token=cdc52dbf-2f39-4510-8089-88a214b4d68c"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus31()){
            //todo:set context
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPreferenceConfig.getstatus31()){
                    ...
                    sharedPreferenceConfig.writeImagestatus31(true);
                }else{

                    FirebaseMessaging.getInstance().subscribeToTopic("PairOnStage");//Todo:event name
                    //todo:set context
                    Toast.makeText(PairOnStage.this,"Successfully subscribed for notifications",Toast.LENGTH_LONG).show();
                    sharedPreferenceConfig.writeImagestatus31(false);
                    imageView.setImageResource(R.drawable.belloff);
                }
                }else{
