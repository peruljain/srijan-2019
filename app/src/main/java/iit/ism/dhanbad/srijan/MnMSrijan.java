...
public class MnMSrijan extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Informals%2FMr.Ms%2Fmrmssrijan.jpg?alt=media&token=25aaf0de-79dc-486b-8bee-c31a6b5a0536","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Informals%2FMr.Ms%2Fmrmssrijann.jpg?alt=media&token=5f717f5d-5f18-440d-a8a8-4987504cd24c"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        headingTextView.setText("Mr & Miss Srijan");
        notification();
        place();
        details();
        register();//new line
        ...
        if(sharedPreferenceConfig.getstatus25()){
            //todo:set context
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(connected){
                    if(!sharedPreferenceConfig.getstatus25()){
                        //todo:set context
                        Toast.makeText(MnMSrijan.this,"Unsubscribed from event's notifications", LENGTH_LONG).show();
                        imageView.setImageResource(R.drawable.bell);
                        FirebaseMessaging.getInstance().unsubscribeFromTopic("MnMSrijan");//event name
                        sharedPreferenceConfig.writeImagestatus25(true);
                    }else{

                        FirebaseMessaging.getInstance().subscribeToTopic("MnMSrijan");
                        //todo:set context
                        Toast.makeText(MnMSrijan.this,"Successfully subscribed for notifications", LENGTH_LONG).show();
                        sharedPreferenceConfig.writeImagestatus25(false);
                        imageView.setImageResource(R.drawable.belloff);
                    }
                }
                else{
                    //todo:name of event
                    Toast.makeText(MnMSrijan.this,"Please Check Your Internet Connection", Toast.LENGTH_LONG).show();
                }
    ...
    private void details() {
        ...
        //todo:set context
        final Intent intent = new Intent(MnMSrijan.this,Details.class);
        //todo:set context
        Dialog = new ProgressDialog(MnMSrijan.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(connected){
                    ...
                    ref.child("MnMSrijan").addValueEventListener(new ValueEventListener() {
                        @Override
    ...
    private void place() {
        ...
        //todo:set context
        placess = new AlertDialog.Builder(MnMSrijan.this);//class ka name
        placess.setTitle("Venue");
        placess.create();
        //todo:set context
        progressDialog = new ProgressDialog(MnMSrijan.this);
