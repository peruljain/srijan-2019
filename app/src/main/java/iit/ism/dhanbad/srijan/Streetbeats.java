...
public class Streetbeats extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Dance%2FStreetbeats%2Fsb1.jpg?alt=media&token=ec235676-841d-419c-bf33-63734937c088","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Dance%2FStreetbeats%2Fsb2.jpg?alt=media&token=11aa1497-8aa0-4cda-88af-82a4f263003b","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Dance%2FStreetbeats%2Fsb3.jpg?alt=media&token=31e2bd02-fecd-45cf-b1b3-b05d32379e26"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus47()){
            //todo:set context
            ...
            public void onClick(View v) {
                ...
                if(connected) {
                    if (!sharedPreferenceConfig.getstatus47()) {
                        ...
                        sharedPreferenceConfig.writeImagestatus47(true);
                    } else {
                        ...
                        sharedPreferenceConfig.writeImagestatus47(false);
                        imageView.setImageResource(R.drawable.belloff);
                    }
