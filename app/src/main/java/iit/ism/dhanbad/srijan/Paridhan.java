...
public class Paridhan extends MainActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        headingTextView.setText("Paridhaan");
        notification();
        place();
        details();
        register();//new line
        ...
        if(sharedPreferenceConfig.getstatus32()){
            //todo:set context
            ...
            public void onClick(View v) {
                ...
                if(connected){
                    if(!sharedPreferenceConfig.getstatus32()){
                        ...
                        sharedPreferenceConfig.writeImagestatus32(true);
                    }else{
                        ...
                        sharedPreferenceConfig.writeImagestatus32(false);
                        imageView.setImageResource(R.drawable.belloff);
                    }
                }
                else{
