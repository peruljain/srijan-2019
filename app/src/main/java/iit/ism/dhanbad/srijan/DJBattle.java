...
public class DJBattle extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Informals%2FDJ%2Fdj1.jpg?alt=media&token=40cd7beb-65d1-4b93-b440-cc42ae768657","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Informals%2FDJ%2Fdj2.jpg?alt=media&token=97303c8c-7c3d-422e-9a3b-0c6024f17c38","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Informals%2FDJ%2Fdj3.jpg?alt=media&token=93b77d3e-fa39-4177-95f6-53529ec66768"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus9()){
            //todo:set context
            ...
            public void onClick(View v) {
                ...
                if(connected){
                    if(!sharedPreferenceConfig.getstatus9()){
                        ...
                        sharedPreferenceConfig.writeImagestatus9(true);
                    }else{
                        ...
                        sharedPreferenceConfig.writeImagestatus9(false);
                        imageView.setImageResource(R.drawable.belloff);
                    }
                }
                else{
