...
public class BusinessQuiz extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Quiz%2FBusinessQuiz%2Fbusiness.jpg?alt=media&token=5d8b63f1-0663-48d9-8ac3-b63c14cde18b","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Quiz%2FBusinessQuiz%2Fbusiness2.jpg?alt=media&token=2480ade6-1ffa-4ab1-954d-165e7dee7e87","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Quiz%2FBusinessQuiz%2Fbusiness3.jpg?alt=media&token=45be9971-9b65-4e65-9e8e-18880e751c9a"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus3()){
            //todo:set context
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPreferenceConfig.getstatus3()){
                    ...
                    sharedPreferenceConfig.writeImagestatus3(true);
                }else{
                    ...
                    sharedPreferenceConfig.writeImagestatus3(false);
                    imageView.setImageResource(R.drawable.belloff);
                }
