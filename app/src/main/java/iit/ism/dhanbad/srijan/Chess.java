...
public class Chess extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Games%2FChess%2Fchess1.jpg?alt=media&token=a16dd76c-4202-46b9-915c-e8fdd45a6a4c","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Games%2FChess%2Fchess2.jpg?alt=media&token=b9ddc6ee-db45-463a-b79e-50df431bf2a8","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Games%2FChess%2Fchess3.jpg?alt=media&token=e2867061-e99a-4bf7-a85d-5a624588f10d"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus6()){
            //todo:set context
            ...
            public void onClick(View v) {
                ...
                if(connected){
                    if(!sharedPreferenceConfig.getstatus6()){
                        ...
                        sharedPreferenceConfig.writeImagestatus6(true);
                    }else{
                        ...
                        sharedPreferenceConfig.writeImagestatus6(false);
                        imageView.setImageResource(R.drawable.belloff);
                    }
                }
                else{
