...
public class Snooker extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Games%2FBilliards%2Fbill2.jpg?alt=media&token=67fd74ae-9788-4765-84d5-5397be5bb49e","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Games%2FBilliards%2Fbill3.jpg?alt=media&token=c1ec2fcb-24a7-4eda-bdb5-f319fc0521a2"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus44()){
            //todo:set context
            ...
            public void onClick(View v) {
                ...
                if(connected){
                    if(!sharedPreferenceConfig.getstatus44()){
                        ...
                        sharedPreferenceConfig.writeImagestatus44(true);
                    }else{
                        ...
                        sharedPreferenceConfig.writeImagestatus44(false);
                        imageView.setImageResource(R.drawable.belloff);
                    }
                }
                else{
