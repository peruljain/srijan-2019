...
public class Hallabol extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Dramatics%2FHallabol%2Fstreet1.jpg?alt=media&token=c54a1317-2dfd-4028-8856-d79451b84ab2","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Dramatics%2FHallabol%2Fstreet2.jpg?alt=media&token=1b827adf-869a-4769-8b2e-8a54d0063865","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Dramatics%2FHallabol%2Fstreet3.jpg?alt=media&token=8c4a0c84-5a74-48f5-9ad7-a53cbf85ec59"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus17()){
            //todo:set context
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPreferenceConfig.getstatus17()){
                    ...
                    sharedPreferenceConfig.writeImagestatus17(true);
                }else{

                    FirebaseMessaging.getInstance().subscribeToTopic("Hallabol");//Todo:event name
                    //todo:set context
                    Toast.makeText(Hallabol.this,"Successfully subscribed for notifications",Toast.LENGTH_LONG).show();
                    sharedPreferenceConfig.writeImagestatus17(false);
                    imageView.setImageResource(R.drawable.belloff);
                }
                }else{
