...
public class Reflection extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Dance%2FReflection%2Fref1.jpg?alt=media&token=f16cfcf3-d0a5-421c-9676-3cc3bf1bb4fc", "https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Dance%2FReflection%2Fref2.jpg?alt=media&token=f7941ace-362d-4361-af65-968be733dafd"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus39()){
            //todo:set context
            ...
            public void onClick(View v) {
                ...
                if (connected) {
                    if (!sharedPreferenceConfig.getstatus39()) {
                        ...
                        sharedPreferenceConfig.writeImagestatus39(true);
                    } else {
                        ...
                        sharedPreferenceConfig.writeImagestatus39(false);
                        imageView.setImageResource(R.drawable.belloff);
                    }
                } else {
