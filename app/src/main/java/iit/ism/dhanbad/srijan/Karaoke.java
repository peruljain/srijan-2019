...
public class Karaoke extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Informals%2FKaraoke%2Fkaraoke1.jpg?alt=media&token=462f572c-20af-48ad-9e30-b767d0810cfa","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Informals%2FKaraoke%2Fkaraoke2.jpg?alt=media&token=fe99e6f3-6c22-4c7d-94cd-ac84b854e384","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/Informals%2FKaraoke%2Fkaraoke3.jpg?alt=media&token=70d43491-7016-4587-9bcb-20b4cfef0687"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus21()){
            //todo:set context
            ...
            public void onClick(View v) {
                ...
                if(connected){
                    if(!sharedPreferenceConfig.getstatus21()){
                        ...
                        sharedPreferenceConfig.writeImagestatus21(true);
                    }else{
                        ...
                        sharedPreferenceConfig.writeImagestatus21(false);
                        imageView.setImageResource(R.drawable.belloff);
                    }
                }
                else{
