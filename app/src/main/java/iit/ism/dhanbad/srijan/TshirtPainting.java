...
public class TshirtPainting extends MainActivity {
    ...
    String[] photos = {"https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/FineArt%2FTshirtPainting%2Fshirt2.jpg?alt=media&token=e52af487-64bc-456f-85c2-47e9ab8331d7","https://firebasestorage.googleapis.com/v0/b/srijan-6df05.appspot.com/o/FineArt%2FTshirtPainting%2Fshirt3.jpg?alt=media&token=f6721b33-bd89-4134-8e6f-2adb6dc8c46b"};
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(sharedPreferenceConfig.getstatus49()){
            //todo:set context
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPreferenceConfig.getstatus49()){
                    ...
                    sharedPreferenceConfig.writeImagestatus49(true);
                }else{

                    FirebaseMessaging.getInstance().subscribeToTopic("TshirtPainting");//Todo:event name
                    //todo:set context
                    Toast.makeText(TshirtPainting.this,"Successfully subscribed for notifications",Toast.LENGTH_LONG).show();
                    sharedPreferenceConfig.writeImagestatus49(false);
                    imageView.setImageResource(R.drawable.belloff);
                }
